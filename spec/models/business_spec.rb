...
RSpec.describe Business, type: :model do
  it 'Valid if name is present' do
    @user = User.create!(name: 'oyinlade', email: 'oyinlade2@gmail.com', password: 123_456)
  ...
  it 'must be associated with a category' do
    ...
    @business = Business.create(name: 'goods', amount: 200, author_id: @user.id)
    @category_businesses = @business.category_businesses.create(business_id: @business.id,
